...
describe('Service Tests', () => {
  describe('Commit Service', () => {
    ...
    let elemDefault: ICommit;
    let expectedResult: ICommit | ICommit[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Commit(0, 'AAAAAAA', 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Commit', () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB',
            author: 'BBBBBB',
